...
import { turbo_backend } from '../../../declarations/turbo_backend/index';
...
export default function UserPost() {
  ...
  const fetchComments = useCallback(async () => {
    try {
      const commentsResult = await turbo_backend.getAllComments();
  ...
  const handlePostComment = async (e) => {
    ...
    try {
      const userActions = []; 
      const commentsResult = await turbo_backend.createComment({
        userEmail: userEmail,
